      ...
      <div class="main-header">
        ...
        <div class="logo-header" data-background-color="blue">
          ...
          <a href="index.jsp" class="logo">
            <img src="assets/img/spa2.png" width="70%" height="70%" alt="navbar brand" class="navbar-brand">
          </a>
                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                  <div class="dropdown-user-scroll scrollbar-outer">
                    ...
                    <li>
                      ...
                      <a class="dropdown-item" href="/utp2023/PersonaLogoutServlet">Logout</a>
                    </li>
                  </div>
                </ul>
              </li>
        ...
        <footer class="footer">
          <div class="container-fluid">
            ...
            <div class="copyright ml-auto">
              2023, made with <i class="fa fa-heart heart text-danger"></i> by <a href="#">Grupo Integrador</a>
            </div>				
          </div>
        </footer>
      </div>
