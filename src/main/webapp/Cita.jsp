                  ...
                  <form  action="CitaCreateServlet" method="post">
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        <div class="form-group form-group-default">
                          <label>Cliente</label>
                          <select class="form-control" name="addClienteId">
              ...
              <tbody>
                <c:forEach var="tempObjeto" items="${mi_lista_de_citas }">
                  <tr>
                    ...
                    <td>${tempObjeto.servicioId.descripcion}<br>${tempObjeto.servicioId.minutos}min<br>S/${tempObjeto.servicioId.precio}</td>
                        ...
                        <form  action="CitaDestroyServlet" method="post">
                          <div class="row">
                            <div class="col-sm-12">
                              ...
                              <div class="form-group form-group-default">
                                <label>Fecha</label>
                                <input type="text" class="form-control" value="${tempObjeto.fecha.getDate()}/${tempObjeto.fecha.getMonth()}" readonly>
                              </div>
                              <div class="form-group form-group-default">
                                <label>Hora</label>
                              ...
                              <div class="form-group form-group-default">
                                <label>Cliente</label>
                                <input type="text" class="form-control" value="${tempObjeto.clienteId.nombres} - ${tempObjeto.clienteId.apellidos}" readonly>
                              </div>
                              <div class="form-group form-group-default">
                                <label>Técnico</label>
                                <input type="text" class="form-control" value="${tempObjeto.tecnicoId.nombres} - ${tempObjeto.tecnicoId.apellidos}" readonly>
                              </div>
                        ...
                        <form  action="CitaEditServlet" method="post">
                          <div class="row">
                            <div class="col-sm-12">
                              ...
                              <div class="form-group form-group-default">
                                <label>Cliente</label>
                                <select class="form-control" name="editClienteId">
                                  <c:forEach var="temp" items="${mi_lista_de_personas}">
                                    <c:if test="${temp.tipoPersonaId.descripcion.equalsIgnoreCase('Cliente')}">  
                                      <option value="${temp.id}">${temp.nombres} - ${temp.apellidos}</option>
                                    </c:if>
                              ...
                              <div class="form-group form-group-default">
                                ...
                                <select class="form-control" name="editServicioId">
                                  <c:forEach var="temp" items="${servicios}">
                                    <option value="${temp.id}">${temp.descripcion}: ${temp.minutos}min: S/${temp.precio}</option>
                                  </c:forEach>
                                </select>
                              </div>
                              <div class="form-group form-group-default">
