...
//      System.out.println(jpacontroller_object.findDistritoEntities());
      ...
      System.out.println("--------------------Antes del lambda--------------------");
      personas.forEach(per -> {
        System.out.print(per.getId() + ": " + per.getNombres() + ": " + per.getEmail() + ": ");
        per.getTelefonoList().forEach(tel -> System.out.print("Telefonos: " + tel.getDescripcion() + ", "));
        System.out.println();
      });
      System.out.println("--------------------Después del Lambda--------------------");

      for (Persona per : personas) {
        System.out.print(per.getId() + ": " + per.getNombres() + ": " + per.getEmail());

//        Reemplazando foreach por expresion Lambda
        per.getTelefonoList().forEach(p -> System.out.print(" - Telefono: " + p.getDescripcion()));
//        for (Telefono tel : per.getTelefonoList()) {
